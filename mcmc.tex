...
...Make triangle plots.  Great value!

Finally, if you pass the above tests but things are still incomprehensible,
  it is often a problem with the likelihood function.
