...
\begin{eqnarray}
\tau = 1 + 2\,\sum_{\Delta = 1}^{\infty} C(\Delta)
...
\begin{eqnarray}
  \Var[E[q]] &=& \frac{\tau}{K}\,\Var[q]
  \\
  &\approx& \frac{\tau}{K^2}\,\sum_{k=1}^K \left(q(\pars_k) - E[q]\right)^2
  \quad ,
\end{eqnarray}
...
Plot the estimated $\tau$ as a function of $M$.
...
Overplot this estimate on the plot of $\tau(M)$.
\end{problem}
