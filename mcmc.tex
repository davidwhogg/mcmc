...
% - follow up the idea that burn-in doesn't exist at all!
...
\footnotetext{%
    ...
    license\note{\label{note:first}
        Copyright 2013, 2014, 2015, 2016 the authors. This work is licensed under a
...
Also look up or compute the analytic values of these for a top-hat
...
Make four plot of these four estimates as a function of $\ln K$, for
$K=2^n$ for $n=8$ up to $n=20$ (that is, $K=256$, $K=512$, and so on
up to $K=1048576$).
