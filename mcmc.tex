...
\begin{equation}
C(\Delta) &\equiv& \frac{E[(\pars_t - \mu)\,(\pars_{t+\Delta} - \mu)]}{E[(\pars_t)^2]
\\
\mu &=& E[\pars_t]
\quad ;
\end{equation}
...
a sampling-based expectation value estimate.\note{HOGG Explain more fully.}

Of course, the autocorrelation-time definition does not by itself provide
an \emph{estimator} for the time.
