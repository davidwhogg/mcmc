...
Because \MCMC\ provably (under assumptions\note{HOGG: Hint at assumptions
  here.}, some of which will be discussed) samples the full
...
HOGG: ...Why does \MH\ \MCMC\ work (briefly)?  Here or later?
...
That is, you can \emph{never know} that you have correctly sampled the posterior pdf,
  ...
  \note{Give example statements... HOGG: Mention cases in which you \emph{might} be able to claim this...}
...
The Goldilocks value is between a half and about a quarter,
  ...
  performance in high dimensional problems\note{%
    ...
    are laid out in \citet{gelman234}.}
...
We strongly recommend this\note{HOGG:  And we do this WHERE? Cite Lang, cite eccentricity; etc??};
