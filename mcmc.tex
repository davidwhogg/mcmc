...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=0.5\textwidth]{problems/p2}
\end{center}
...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=0.5\textwidth]{problems/p3}
\end{center}
...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=0.7\textwidth]{problems/p4a}
\end{center}
...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=0.7\textwidth]{problems/p4b}
\end{center}
\caption{Solution to \problemname~\ref{prob:twod}b:
MCMC samples from a two-dimensional top hat distribution (scatter plot) and the
one-dimensional marginalized distributions (histograms).}
\label{fig:twod}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=\textwidth]{problems/p5}
\end{center}
\caption{Solution to \problemname~\ref{prob:MH-sigma}:
MCMC samples from a two-dimensional top hat distribution (scatter plot) and the
one-dimensional marginalized distributions (histograms).}
\label{fig:MH-sigma}
\end{figure}
