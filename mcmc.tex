...
% to-do
% -----
% - deal with \MCMC\ macro in footnotes.
...
If you want to think about autocorrelation estimation:\note{One of us (DFM) has written
  ...
  at \url{http://emcee.readthedocs.io/en/develop/tutorials/autocorr/}.}
...
trusted if the chain is many times ($\sim 100$) longer than $\tau$.\footnote{This
  ...
  \url{http://emcee.readthedocs.io/en/develop/tutorials/autocorr/}, where
