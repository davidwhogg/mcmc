...
Either it is taking too long---they have take too many steps or
execute too many calls of the function $f(\pars)$---or it is not
...
or statistics literature.\note{HOGG: Your best interface to these
  literatures is via a colleague.  Break down those walls!}
...
...Gibbs!  Every parameter is differently difficult to sample in?

...What, briefly, is the stretch move, and why is it useful?  Every parameter treated identically---almost opposite to gibbs.
