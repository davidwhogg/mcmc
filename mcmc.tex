...
\affil{Center for Computational Astrophysics, Flatiron Institute, 162 Fifth Ave, New York, NY 10010, USA\hspace*{-1cm}}
...
This latter is a detail to which we return below. \textbf{HOGG DO WE?}
...
\end{eqnarray}
  ...
  when the $g(\pars_k)$ have been ordered (sorted).
